...
| Status | Meaning |
|--------|---------|
| `Stable` | Ratified by community — implementers can build against this |
| `Draft` | Complete enough to read and discuss — may still change |
| `Incomplete` | Exists but missing critical sections |
| `Planned` | Defined in roadmap, file not yet created |
| `Superseded` | Replaced by a newer document |

No specification has reached `Stable` yet. This is the work of `v0.1.1` → `v1.0.0`.

---

## Core Specifications

| Document | Status | Blocking Issues |
|----------|--------|----------------|
...
| Document | Status | Blocking Issues |
|----------|--------|----------------|
| [identity-protocol.md](docs/protocols/identity/identity-protocol.md) | Draft | Humanode integration API not yet finalized |
| [proximity-proof.md](docs/protocols/identity/proximity-proof.md) | Planned | — |
...
| Document | Status | Blocking Issues |
|----------|--------|----------------|
| [dao-codex.md](docs/protocols/governance/dao-codex.md) | Draft | Governance mechanics not yet finalized |
